        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 ">
            <div
                ...
                <nav class="hidden space-x-10 md:flex ">
                    ...
                    <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">WHITE LANDS</a>
                    <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">LIMEÑA</a>
                    <a href="/en/ride" class="text-base font-medium text-gray-500 hover:text-gray-900">HORSEBACK RIDING</a>
                    <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">ADVENTURE</a>
