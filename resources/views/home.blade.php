    ...
    <main class="container">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 py-10">
            <div class="col-span-2">
                <img class="rounded-2xl" src="{{ asset('img/21.jpeg') }}" alt="">
            </div>
            <div class="grid place-content-center">
                <div class="md:relative right-20 bg-white py-12 px-10 md:px-14  rounded-2xl shadow-lg ">
                    ...
                    <div class="flex items-center justify-center">
                        <a href=""
                            class="w-full text-center bg-limena-500 hover:bg-limena-400 duration-150 transition-all py-2 px-4 rounded-lg text-white">VER
                            MAS</a>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 py-10">
            ...
            <div class="grid place-content-center">
                <div class="md:relative left-20 bg-white py-12 px-10 md:px-14 rounded-2xl shadow-lg ">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 py-10">
            <div class="col-span-2">
                <img class="rounded-2xl" src="{{ asset('img/3.jpeg') }}" alt="">
            </div>
            <div class="grid place-content-center">
                <div class="md:relative right-20 bg-white py-16 px-8 rounded-2xl shadow-lg ">
